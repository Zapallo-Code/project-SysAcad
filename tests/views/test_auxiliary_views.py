...
class TestDedicationTypeViewSet(unittest.TestCase):
    ...
    @patch('app.views.dedication_type.DedicationTypeService')
    @patch('app.views.dedication_type.DedicationTypeSerializer')
    def test_create_success(self, mock_serializer_class, mock_service):
        """Test creating a dedication type successfully."""
        from app.views import DedicationTypeViewSet
        
        mock_serializer = MagicMock()
        mock_serializer.is_valid.return_value = True
        mock_serializer.validated_data = self.dedication_data
        mock_serializer.data = self.dedication_data
        mock_serializer_class.return_value = mock_serializer
        
        mock_service.create.return_value = self.mock_dedication
        
        viewset = DedicationTypeViewSet()
        request = self.factory.post('/api/dedication-types/', self.dedication_data)

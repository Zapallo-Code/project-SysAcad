...
class TestUniversityViewSet(unittest.TestCase):
    ...
    @patch('app.views.university.UniversityService')
    @patch('app.views.university.UniversitySerializer')
    def test_create_university_success(self, mock_serializer_class, mock_service):
        ...
        mock_serializer.data = self.university_data
    ...
    @patch('app.views.university.UniversitySerializer')
    def test_create_university_invalid_data(self, mock_serializer_class):
    ...
    @patch('app.views.university.UniversityService')
    @patch('app.views.university.UniversitySerializer')
    def test_update_university_success(self, mock_serializer_class, mock_service):
        ...
        viewset = UniversityViewSet()
        request = self.factory.put('/api/universities/1/', self.university_data)
        response = viewset.update(request, pk=1)
        
        mock_service.update.assert_called_once_with(1, self.university_data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    @patch('app.views.university.UniversitySerializer')
    def test_update_university_invalid_data(self, mock_serializer_class):

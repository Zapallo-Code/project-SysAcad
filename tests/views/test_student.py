...
class TestStudentViewSet(unittest.TestCase):
    ...
    @patch("app.views.student.StudentService")
    def test_create_student_success(self, mock_service):
        ...
        viewset = StudentViewSet()
        request = self.factory.post("/api/students/", self.student_data, format="json")
    ...
    def test_create_student_invalid_data(self):
        ...
        viewset = StudentViewSet()
        request = self.factory.post("/api/students/", {}, format="json")
        response = viewset.create(request)

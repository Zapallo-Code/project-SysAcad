...
class TestODTDocument(unittest.TestCase):
    ...
    @patch('app.utils.document_generator.os.path.join')
    def test_generate_odt_success(self, mock_join, mock_renderer, mock_template_class,
                                   mock_exists, mock_unlink, mock_file):
        ...
        mock_template_class.return_value.__enter__ = MagicMock(return_value=mock_odt_template)
    ...
    @patch('app.utils.document_generator.ODTTemplate')
    @patch('app.utils.document_generator.get_odt_renderer')
    def test_generate_odt_render_error(self, mock_renderer, mock_template_class,
...
class TestDOCXDocument(unittest.TestCase):
    ...
    @patch('app.utils.document_generator.os.path.join')
    def test_generate_docx_success(self, mock_join, mock_jinja_env, mock_docx_class,
                                    mock_exists, mock_unlink, mock_file):

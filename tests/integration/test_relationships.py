...
class TestUniversityFacultyIntegration(unittest.TestCase):
    ...
    def test_create_university_with_faculties(self, mock_faculty_service, mock_uni_service):
    ...
    def test_cascade_delete_university_with_faculties(self, mock_uni_repo, mock_fac_repo):
...
class TestFacultySpecialtyIntegration(unittest.TestCase):
    ...
    @patch('app.services.faculty.FacultyService')
    def test_faculty_with_multiple_specialties(self, mock_fac_service, mock_spec_service):
...
class TestSpecialtyPlanSubjectChain(unittest.TestCase):
    ...
    @patch('app.services.specialty.SpecialtyService')
    def test_complete_academic_chain(self, mock_spec_service, mock_plan_service, mock_subj_service):

...
class TestUniversityAPIWorkflow(unittest.TestCase):
    ...
    def test_create_retrieve_update_delete_workflow(self, mock_serializer_class, mock_service):
...
class TestStudentAPIWorkflow(unittest.TestCase):
    ...
    def test_student_search_and_filter_workflow(self, mock_serializer_class, mock_service):
...
class TestSubjectPositionWorkflow(unittest.TestCase):
    ...
    def test_create_subject_then_positions(self, mock_pos_ser, mock_subj_ser, mock_pos_service, mock_subj_service):
...
class TestValidationErrorHandling(unittest.TestCase):
    ...
    @patch('app.views.university.UniversitySerializer')
    def test_invalid_data_returns_400(self, mock_serializer_class):

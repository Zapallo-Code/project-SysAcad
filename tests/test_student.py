...
from tests.instancias import new_student, new_document_type
...
class StudentTestCase(TestCase):
    ...
    def test_actualizar(self):
        student = new_student()
        student.name = "Juan actualizado"
        updated_student = StudentService.update(student.id, student)
        self.assertEqual(updated_student.name, "Juan actualizado")

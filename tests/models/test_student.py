...
class TestStudentModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_document_type = MagicMock()
        ...
        self.valid_data = {
            ...
            "document_type": self.mock_document_type,
    ...
    def test_clean_birth_date_in_future(self):
    ...
    def test_clean_enrollment_before_birth(self):

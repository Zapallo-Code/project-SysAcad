...
from tests.instancias import new_department
...
class DepartmentTestCase(TestCase):
    ...
    def test_crear(self):
        ...
        self.assertEqual(departamento.name, "Matematicas")
    ...
    def test_buscar_todos(self):
        ...
        departamento2 = new_department("Fisica")
    ...
    def test_actualizar(self):
        departamento = new_department()
        departamento.name = "Matematicas actualizado"
        departamento_actualizado = DepartmentService.update(departamento.id, departamento)
        self.assertEqual(departamento_actualizado.name, "Matematicas actualizado")
